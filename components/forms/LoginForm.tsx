...
export function LoginForm() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (process.env.NODE_ENV === 'development' && 
        ...
        // Store dummy session in localStorage for development
        const dummySession = {
          user: {
            id: DUMMY_USER.id,
  ...
  const handleQuickLogin = async () => {
    ...
    try {
      ...
      setValue('password', DUMMY_USER.password)
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-blue-700 mt-1">
                Use demo credentials: {DUMMY_USER.email} / {DUMMY_USER.password}
              </p>
            </div>
            <Button
              type="button"
