      ...
      <div className="hidden lg:flex lg:w-1/2 bg-purple-900 text-white p-12 flex-col justify-between">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <p className="text-xl mb-12 text-purple-100">
            Sign in to continue planning and sharing amazing trip routes with travelers around the world.
          </p>
          ...
          <div className="space-y-6 mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold">Access Your Routes</h3>
                <p className="text-purple-200">Continue planning your next adventure</p>
              </div>
            </div>
